 ...
 */
abstract class AbstractPolygon extends JComponent implements
		IPolygon {
	...
	protected abstract void manipulatePoint(Point center,
			Point p);

	protected List<Point> getPointsWithBase(
			AbstractPolygon base) {
